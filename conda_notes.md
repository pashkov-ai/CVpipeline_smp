...
`conda install pytorch pytorch-cuda=12.4 pytorch-lightning segmentation-models-pytorch albumentations hydra-core mlflow-skinny onnx -c pytorch`
...
`conda create -n CVpipeline-onnx python=3.11 && conda activate CVpipeline-onnx`
`conda install onnx=1.20.0 onnxruntime onn`